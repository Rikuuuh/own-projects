...
class AutoVaraukset extends StatelessWidget {
  const AutoVaraukset({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    Stream<List<Map<String, dynamic>>> getAutoReservationData() {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Autopaikan varaukset',
