...
class SaunaVaraukset extends StatelessWidget {
  const SaunaVaraukset({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    Stream<List<Map<String, dynamic>>> getSaunaReservationData() {
