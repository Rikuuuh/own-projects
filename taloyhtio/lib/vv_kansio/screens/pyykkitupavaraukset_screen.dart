...
class PyykkitupaVarauksetScreen extends StatelessWidget {
  const PyykkitupaVarauksetScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Pyykkituvan varaukset'),
      ),
      body: Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              'Laitteen numero: ${reservationData['laite']}',
                              style: const TextStyle(
                                fontWeight: FontWeight.bold,
                              ),
                            ),
